...
#define	STR_DADDY	"WAAAAAHHHHH!"
#define	STR_HURTME	"OSA Rookie"
#define	STR_BRINGEM	"OSA Agent"
#define	STR_DEATH	"OSA Lieutenant"
#define STR_DEATHMSG	"Are you sure? This difficulty isn't\neven remotely fair!"
