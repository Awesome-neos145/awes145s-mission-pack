...
DEBUG	=	0
    ...
    EXTRN   SDL_SBIncSegPtr:FAR
    EXTRN	SDL_SBStopSample:FAR
    EXTRN   SDL_SBPlaySeg:FAR
...
DATASEG
    ...
    EXTRN   sbLocation:WORD
    EXTRN   sbNextSegPtr:DWORD
    EXTRN   sbNextSegLen:DWORD
	EXTRN	sqActive:WORD
...
PUBLIC SDL_SBService
	...
	; load next segment
	;
    mov edi,[sbNextSegLen]

    call SDL_SBPlaySeg C,eax,edi
    ...
    ;
    sub eax,eax
	mov	[sbNextSegPtr],eax
	jmp	intack

    ;
    ; perform Borland's dreadful huge pointer arithmetic
    ;
hugeproblems:
    sub edi,eax
    mov [sbNextSegLen],edi

	call SDL_SBIncSegPtr C,eax

	jmp	intack

lastseg:
    call SDL_SBStopSample
