...
unsigned	spearangle;
boolean		spearflag;
int			warpwx,warpwy,warpex,warpey,warpnx,warpny,warpsx,warpsy;
int			truckox,truckoy,trucktx,truckty,truckhx,truckhy,truckfx,truckfy;
byte		pwx,pwy,pw2x,pw2y,pw3x,pw3y,pw4x,pw4y;

//
// ELEVATOR BACK MAPS - REMEMBER (-1)!!
//
int ElevatorBackTo[]={0,1,7,3,5,3}; // you get sucked into a wormhole, which is why it sends you to E1M1
...
#define ATABLEMAX 9 // did this to save a few hundred bytes of memory
...
void ScanInfoPlane (void)
{
	...
	for (y=0;y<mapheight;y++)
		for (x=0;x<mapwidth;x++)
		{
			...
			case 100: // warp in east
				SpawnStatic(x,y,23);
				break;
			case 101: // warp out east
				warpex = x;
				warpey = y;
				break;
			case 102: // warp in west
				SpawnStatic(x,y,23);
				break;
			case 103: // warp out west
				warpwx = x;
				warpwy = y;
				break;
			case 104: // warp in north
				SpawnStatic(x,y,23);
				break;
			case 105: // warp out north
				warpnx = x;
				warpny = y;
				break;
			case 106: // warp in south
				SpawnStatic(x,y,23);
				break;
			case 107: // warp out south
				warpsx = x;
				warpsy = y;
				break;
			case 23:
			...
			case 79:	// fuel can
				SpawnStatic(x,y,51);
				break;
			case 80:	// flamethrower
				SpawnStatic(x,y,52);
				break;
			case 81:	// special death sequence tile
				if (gamestate.deathsequencecount < 100)
				{
					gamestate.deathsequencetiles[gamestate.deathsequencecount].tx = x;
					gamestate.deathsequencetiles[gamestate.deathsequencecount].ty = y;
					gamestate.deathsequencecount++;
				}
				break;
			case 82:	// instawarp truck one
				SpawnStatic(x,y,23);
				break;
			case 83:	// instawarp one out
				truckox = x;
				truckoy = y;
				break;
			case 84:	// instawarp truck two
				SpawnStatic(x,y,23);
				break;
			case 85:	// instawarp two out
				trucktx = x;
				truckty = y;
				break;
			case 86:	// instawarp truck three
				SpawnStatic(x,y,23);
				break;
			case 87:	// instawarp three out
				truckhx = x;
				truckhy = y;
				break;
			case 88:	// instawarp truck four
				SpawnStatic(x,y,23);
				break;
			case 89:	// instawarp four out
				truckfx = x;
				truckfy = y;
				break;
			case 1:     //open truck
				SpawnStatic(x,y,54);
				(unsigned)actorat[x][y] = 1;
				break;
			case 2:     //spear base warp
				SpawnStatic(x,y,23);
				break;
			case 3:	    //stove
				SpawnStatic(x,y,53);
...
//
	...
	if (mapwidth != 64 || mapheight != 64)
		Quit ("Map is either too small or large! Error 11");
...
==================
*/
// we don't really use demos anymore
...
//
	...
	if (gamestate.lives > -1)
	{
		...
		gamestate.rockets = 0;
		gamestate.fuel = 0;
		gamestate.maxammo = 199;
		gamestate.maxhealth = 100;
		gamestate.hasweapon[wp_knife] = true;
...
#ifndef SPEAR
			// Skip fade if coming from death sequence - keep palette black
			if (!(gamestate.deathsequence == 0 && gamestate.deathsequencefaded))
			{
				VW_FadeOut ();
			}
			else
			{
				// Ensure palette stays black for death sequence victory
				byte blackpal[768];
